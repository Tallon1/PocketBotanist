...
import static com.java.pocketbotanist.utils.AlertDialogUtils.showDeletePlantDialog;
import static com.java.pocketbotanist.utils.FirebaseConstants.FIREBASE_IMAGE_REFERENCE;
import static com.java.pocketbotanist.utils.ProgressUtils.daysFromLastAction;
import static com.java.pocketbotanist.utils.TimeUtils.DATE_FORMAT;
...
import com.java.pocketbotanist.databinding.ItemMyPlantBinding;
...
public class MyPlantsAdapter extends RecyclerView.Adapter<MyPlantsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(
                ItemMyPlantBinding.inflate(LayoutInflater.from(context), parent, false));
    }
