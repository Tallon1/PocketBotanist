...
import static com.java.pocketbotanist.utils.Constants.PERMISSION_CAMERA;
import static com.java.pocketbotanist.utils.Constants.PERMISSION_STORAGE;
import static com.java.pocketbotanist.utils.Constants.PICK_IMAGE_CAMERA;
import static com.java.pocketbotanist.utils.Constants.PICK_IMAGE_GALLERY;
import static com.java.pocketbotanist.utils.Constants.PLANT_INTENT_EXTRAS_KEY;
import static com.java.pocketbotanist.utils.Constants.WRITE_EXTERNAL_STORAGE;
import static com.java.pocketbotanist.utils.ProgressUtils.daysToProgress;
import static com.java.pocketbotanist.utils.ProgressUtils.progressToDays;
import static com.java.pocketbotanist.utils.SeekBarUtils.initSeekBarGroupWithText;
import static com.java.pocketbotanist.utils.TimeUtils.getCurrentDate;
import static com.java.pocketbotanist.utils.TimeUtils.getTimestamp;
...
import com.java.pocketbotanist.core.add.AddContract;
import com.java.pocketbotanist.core.add.AddPresenter;
...
public class AddPlantFragment extends BaseFragment implements AddContract.View {
    ...
    private void initButtons() {
        ...
        // Go to Scanning Activities - Species (ScanS) & Disease (ScanD)
        binding.ivScanS.setOnClickListener(v -> goToScanSActivity());
        binding.ivScanD.setOnClickListener(v -> goToScanDActivity());
    ...
    private void goToScanSActivity() {
        Context activity;
        Intent intent = new Intent(getContext(), ScanSActivity.class);
        getContext().startActivity(intent);
    }

    private void goToScanDActivity() {
        Context activity;
        Intent intent = new Intent(getContext(), ScanDActivity.class);
        getContext().startActivity(intent);
    }
