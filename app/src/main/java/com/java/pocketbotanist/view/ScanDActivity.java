...
import com.java.pocketbotanist.databinding.ActivityScanDBinding;
...
public class ScanDActivity extends Activity implements ScanContract{
    ...
    private MappedByteBuffer loadModelFile(Activity activity) throws IOException {
        AssetFileDescriptor fileDescriptor = activity.getAssets().openFd("diseaseModel.tflite");
    ...
    private void showResult() {
        ...
        try {
            labels = FileUtil.loadLabels(this, "diseaseDict.txt");
        } catch (Exception e){
            e.printStackTrace();
        }
